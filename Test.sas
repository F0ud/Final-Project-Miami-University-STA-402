...
data WORK.PBP_DATA    ;
infile 'C:\Users\fuaad\STA 402\STA402_final\2015-16_pbp.csv' delimiter = ',' MISSOVER DSD lrecl=32767 firstobs=2 ;
...
data WORK.GAME_DATA;
infile 'C:\Users\fuaad\STA 402\STA402_final\gamedates_2016-17.csv' dsd firstobs=2;
